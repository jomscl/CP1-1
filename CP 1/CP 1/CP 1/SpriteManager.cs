...
namespace CP_1
{
    ...
    public class SpriteManager : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        protected override void LoadContent( )
        {
            ...
            spriteList.Add(new EvadingSprite(Game.Content.Load<Texture2D>(@"Images/NPC"), new Vector2(600, 400), new Point(35, 60), 10, new Point(0, 0), new Point(7, 2), new Vector2(1, 1), "", this, .75f, 150, SpriteEffects.None, new Point(0, 0)));
